...
ScaffoldSetHead * ScaffoldingContigSet(ContigSet * contigSet, ReadSet * readSet, int setNumber, long int start, long int length, int totalThreadNumber){
    ...
    for(i=0;i<count;i++){
        ...
        //cout<<i<<"---"<<linkRight[i][0]<<"---"<<linkRight[i][1]<<"---"<<linkRight[i][2]<<"---"<<linkRight[i][3]<<endl;
    }
    //cout<<"-----------------------------------------------"<<endl;
    for(i=0;i<count;i++){
        if(linkLeft[i][0]==-1){
        ...
        //cout<<i<<"---"<<linkLeft[i][0]<<"---"<<linkLeft[i][1]<<"---"<<linkLeft[i][2]<<"---"<<linkLeft[i][3]<<endl;
    }
    */
    ...
    for(i = 0; i < count; i++){
        ...
        //cout<<"ttttttttttttttttttttttttt--"<<i<<endl;
    ...
    //ComputeResult(scaffoldSetHead);
    /*
    char * str = new char[100];
    strcpy(str, "scaffoldLongN.fa");
    WriteScaffoldSetLongN(scaffoldSetHead, str);
    ContigSet * contigSet1 = GetContigSetLong(str);
    cout<<"------"<<endl;
    ComputeResult(contigSet1,2900000);
    */
